<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand">
        <a href="index.html"><img src="{{ asset('admin/logo.png') }}" alt="Logo Sekolah"
            class="img-responsive logo p-0 pt-0 m-0 mt-0 mb-0" style="width: 50px; margin-bottom:33px;"></a>
        <h3 style="margin-left: 50px; margin-bottom: -33px; margin-top: -63px;">SMKN 1 SUAK TAPEH</h3>
    </div>
